...
import com.test.databinding_twoways.util.Timer
import com.test.databinding_twoways.util.cleanSecondsString
import java.util.*
...
class IntervalTimerViewModel(private val timer: Timer) : ObservableViewModel() {
    ...
    */
    ...
    private var numberOfSetsTotal = INITIAL_NUMBER_OF_SETS // 循环次数
    private var numberOfSetsElapsed = 0 // 已经执行的次数
